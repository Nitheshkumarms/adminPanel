document.addEventListener('DOMContentLoaded', function() {
    ...
    const DOM = {
        ...
        storeSignupForm: document.getElementById('storeSignupForm'),
    ...
    function setupEventListeners() {
        ...
        // Modal open/close
        DOM.addStoreBtn.addEventListener('click', () => DOM.addStoreModal.style.display = 'flex');
        DOM.closeModal.addEventListener('click', () => DOM.addStoreModal.style.display = 'none');
        window.addEventListener('click', (e) => {
            if (e.target === DOM.addStoreModal) {
        ...
        DOM.storeSignupForm.addEventListener('submit', handleStoreSignup);
